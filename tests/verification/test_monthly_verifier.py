...
class TestMonthlyVerifierEdgeCases:
    ...
    def test_calculate_benchmark_return_falls_back_to_available_proxy_symbol(self, db_with_phase3_data):
        ...
        # Pin the proxy list — see the note in tests/api/test_verification.py.
        # The subject is the fallback path, not the contents of whatever
        # settings.yaml happens to exist on the machine running this.
        with patch(
