...
# locale catalogs.
#
# ⚠ This dict is duplicated verbatim in src/services/compass_allocation.py.
# Two copies of one table that must agree is the failure shape this codebase has
# been bitten by repeatedly — if you edit one, edit both, and prefer collapsing
# them into a single import when something else brings you into these files.
# ---------------------------------------------------------------------------
